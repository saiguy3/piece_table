...
class TestPieceTable(unittest.TestCase):
  def setUp(self):
    self.long_string = ("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent maximus"
  ...
  def test_get_piece_and_offset_upper_index_error(self):
    piece_table = PieceTable(self.long_string)
    self.assertRaises(IndexError, piece_table.get_piece_and_offset, len(self.long_string) + 1)
